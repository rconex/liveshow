...
public class tls_sigature {
    private static final int appId = 1400082990;
    private static final String privKey = "-----BEGIN PRIVATE KEY-----\n" +
            "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgxEPAQZEqjvsG/oZw\n" +
            "DUuWwBpxkk2XI8xzqK8Ux3cJG6KhRANCAARAn6FJoowwUJc8s/jpr6M9GDwh+xoy\n" +
            "6C6Z6lsOfFV6B6UmYGLATfRGJLs6Np0p6FDiy7bN7oamXF6Xw7TAzpu9\n" +
            "-----END PRIVATE KEY-----\n";

    public static GenTLSSignatureResult GenTLSSignatureEx(String identifierx) throws IOException {
       return GenTLSSignatureEx(appId,identifierx,privKey);
    }
